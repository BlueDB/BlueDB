...
public abstract class ReadableSegmentManager<T extends Serializable> {
	...
	public abstract List<? extends ReadableSegment<T>> getExistingSegments(Range range, Optional<IncludedSegmentRangeInfo> includedSegmentRangeInfo);
	public abstract List<Range> getExistingSegmentRanges(Range range, Optional<IncludedSegmentRangeInfo> includedSegmentRangeInfo);
