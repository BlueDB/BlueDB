...
public class ReadableSegment <T extends Serializable> implements Comparable<ReadableSegment<T>> {
	...
	public ReadableSegment(Path segmentPath, Range segmentRange, Rollupable rollupable, FileManager fileManager, final List<Long> rollupLevels) {
	...
	protected static <T extends Serializable> ReadableSegment<T> getTestSegment () {
		return new ReadableSegment<T>();
	}

	protected ReadableSegment() {segmentPath = null;segmentRange = null;fileManager = null;rollupLevels = null;rollupable = null;preSegmentRange = null;}
