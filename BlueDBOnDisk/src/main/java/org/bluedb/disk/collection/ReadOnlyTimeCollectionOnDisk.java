...
public class ReadOnlyTimeCollectionOnDisk<T extends Serializable> extends ReadOnlyCollectionOnDisk<T> implements ReadableBlueTimeCollection<T> {
	...
	public ReadOnlyTimeCollectionOnDisk(ReadableDbOnDisk db, String name, Class<? extends BlueKey> requestedKeyType, Class<T> valueType, List<Class<? extends Serializable>> additionalRegisteredClasses) throws BlueDbException {
