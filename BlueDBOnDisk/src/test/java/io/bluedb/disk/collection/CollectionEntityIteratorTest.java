...
public class CollectionEntityIteratorTest extends BlueDbDiskTestBase {
	...
	public void test_close() throws Exception {
        ...
        CollectionEntityIterator<TestValue> iterator = new CollectionEntityIterator<>(getTimeSegmentManager(), new Range(1, 2), false);
	...
	public void test_hasNext() throws Exception {
        ...
        CollectionEntityIterator<TestValue> iterator = new CollectionEntityIterator<>(getTimeSegmentManager(), new Range(0, 0), false);
        assertFalse(iterator.hasNext());
        iterator.close();

        iterator = new CollectionEntityIterator<>(getTimeSegmentManager(), new Range(1, 1), false);
        ...
        iterator = new CollectionEntityIterator<>(getTimeSegmentManager(), new Range(1, 2), false);
        assertTrue(iterator.hasNext());
	...
	public void test_next() throws Exception {
        ...
        iterator = new CollectionEntityIterator<>(getTimeSegmentManager(), new Range(0, 1), false);
        iteratorContents = toList(iterator);
        iterator.close();
        assertEquals(1, iteratorContents.size());


        iterator = new CollectionEntityIterator<>(getTimeSegmentManager(), new Range(0, 2), false);
	...
	public void test_getNext_multiple_time_frames() {
		...
		CollectionEntityIterator<TestValue> collectionIterator = new CollectionEntityIterator<>(getTimeSegmentManager(), new Range(0, segmentSize * 2 - 1), false);
