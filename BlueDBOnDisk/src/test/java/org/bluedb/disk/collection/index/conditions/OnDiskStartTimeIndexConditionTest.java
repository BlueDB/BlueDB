...
public class OnDiskStartTimeIndexConditionTest {
	...
	private OnDiskStartTimeIndexCondition<TestValue> indexCondition = new OnDiskStartTimeIndexCondition<>(indexMocker.getIndex());
	...
	public OnDiskStartTimeIndexConditionTest() {
	...
	public void test_isIn() {
		...
		assertTestMethod(entity2, entity5, entity6);
		assertEquals(toRangeSet(entity2, entity5, entity6), indexCondition.getSegmentRangesToIncludeInCollectionQuery());
	}
	...
	public void test_isGreaterThanANDisLessThan() {
		...
		assertEquals(toRangeSet(entity3, entity4), indexCondition.getSegmentRangesToIncludeInCollectionQuery());
	}
	
	private ValueKey toIndexKey(BlueEntity<TestValue> collectionEntity) {
		return indexCondition.extractStartTimeIndexKeyFromEntity(collectionEntity);
	}
