...
public class DummyReadOnlyBlueCollectionOnDiskTest {
	...
	public void test_get() throws BlueDbException {
		ReadableBlueCollection<TestValue> dummyCollection = new DummyReadOnlyBlueCollectionOnDisk<TestValue>();
	...
	public void test_query() throws BlueDbException, IOException {
		ReadableBlueTimeCollection<TestValue> dummyCollection = new DummyReadOnlyBlueCollectionOnDisk<TestValue>();
