...
public class InsertWriterTest {
	...
	public void test_process_shouldSkipEncryption_skipEncryptionWriteCalledWithExpectedParam() throws BlueDbException {
		...
		BlueKey insertWriterKey = new TimeKey(1, 1);
		...
		InsertWriter<TestValue> insertWriter = new InsertWriter<>(insertWriterKey, new TestValue("Insert this!"));

		// Act
		insertWriter.process(mockInput, mockOutput);
